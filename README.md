...
- **Week 2: A Step Closer to vLLM.** Add a KV cache, establish a
  ...
  model kernels and SIMD-matrix prefill, then tests optional long-context
  dense-KV decode attention and a fused packed-W4 gate+up/SwiGLU candidate.
...
| 2.6 (optional) | Long-Context Dense-KV Decode Attention | ✅ | ✅ | ✅ | 🚧 |
| 2.7 | Fused Packed-W4 Gate+Up and SwiGLU | ✅ | ✅ | ✅ | 🚧 |
