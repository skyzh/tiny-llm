...
- **Week 2: A Faster Single Request.** Day 1 adds `kv-cache` and
  ...
  `simd-matmul`. Fused primitives and tiled attention remain later lessons.
...
The older Week 2 chapter URLs remain available as [historical material](book/src/week2-02-benchmark-profile.md). Their former Day 2–7 test and checkpoint order is separate from the current Day 1 → Day 2 → Day 3 route.
