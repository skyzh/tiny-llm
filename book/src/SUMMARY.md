...
- [🚧 Week 2: Make One Request Faster](./week2-overview.md)
    - [🚧 Day 1: Reuse the Prefix](./week2-01-kv-cache.md)
    - [🚧 Day 2: Bound KV-Cache Movement](./week2-02-benchmark-profile.md)
        - [Optional: Read an Evidence Package](./week2-advanced-profiling.md)
    - [🚧 Day 3: Keep W4 Packed](./week2-03-quantize-model.md)
    - [🚧 Day 4: SIMD Matrix Prefill](./week2-04-fused-model-kernels.md)
    - [🚧 Day 5: Compact Model Primitives](./week2-05-simd-matrix-prefill.md)
    - [🚧 Day 6: Tiled Dense Prefill Attention](./week2-06-operator-lab.md)
    - [🚧 Day 7: Select the Cumulative Path](./week2-07-split-k-prefill.md)
