...
- [Week 2: Optimize Decode](./week2-overview.md)
    - [Benchmarking and the MLX Baseline](./week2-01-benchmarking.md)
    ...
    - [End-to-End Decode Optimization (Days 6-7)](./week2-05-end-to-end.md)
