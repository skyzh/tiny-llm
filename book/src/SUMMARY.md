...
- [Week 2: From Python to Metal](./week2-overview.md)
    - [WIP: Benchmarking and the MLX Baseline](./week2-01-benchmarking.md)
    - [Quantized Matvec and Matmul (Days 2-3)](./week2-02-quantized-matmul.md)
    - [WIP: Fast RMSNorm, RoPE, and SwiGLU](./week2-03-fast-operators.md)
    - [WIP: Decode Attention](./week2-04-decode-attention.md)
    - [WIP: End-to-End Decode Optimization (Days 6-7)](./week2-05-end-to-end.md)
- [Week 3: Build a Mini vLLM](./week3-overview.md)
    - [Key-Value Cache](./week3-01-kv-cache.md)
