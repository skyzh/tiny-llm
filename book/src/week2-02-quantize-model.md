...
Day 1 leaves you with a matched cached-model baseline, a bounded-capacity
checkpoint, and a decode roofline. Keep that baseline fixed while changing the
...
[M3 Ultra](https://support.apple.com/en-au/122211), and
[M4 Pro and Max](https://support.apple.com/en-us/121553). This historical
comparison stops at M4 Pro/Max; it makes no claim about subsequent products.
...
at 33.5% of attributed time, pointing to the later fusion work on Day 4.
These are bounded observations from one machine and two product samples, not
portable timing thresholds. The complete campaign and attribution are in the
