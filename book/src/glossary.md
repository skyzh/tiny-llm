...
- [Capacity-Backed KV Cache](./week2-02-benchmark-profile.md)
- [Quantize the Model](./week2-03-quantize-model.md)
- [SIMD-Matrix Prefill](./week2-04-fused-model-kernels.md)
- [RMSNorm, RoPE, and SwiGLU](./week2-05-simd-matrix-prefill.md)
- [Tiled Prefill Attention](./week2-06-operator-lab.md)
- [Selected Week 2 Path](./week2-07-split-k-prefill.md)
