...
NB_MODULE(_ext, m) {
    ...
    m.def("long_context_attention", &tiny_llm_ext_ref::long_context_attention, "query"_a, "key"_a, "value"_a,
          "no_mask"_a, "scale"_a, "is_causal"_a, "num_heads"_a, "num_kv_heads"_a, "stream"_a = nb::none());
